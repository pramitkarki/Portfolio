...
export default function Resume() {
  ...
  const PDF_URL = "/docs/Pramit_Karki_Resume.pdf";
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        >
          <div className="text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-secondary-foreground mb-2">
              Resume
            </h1>
