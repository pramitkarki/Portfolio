      ...
      try {
        ...
        await emailjs.send(
          ...
          process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID!,
          {
            ...
            to_name: "Pramit Karki",
            from_name: formValues.senderName,
            from_email: formValues.senderEmail,
            message: `Contact Reason: ${formValues.reasonToContact}\n\n${formValues.senderMsg}`,
          },
          process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY!
        );

        // Send auto-reply to the user (if auto-reply template ID is set)
        if (process.env.NEXT_PUBLIC_EMAILJS_AUTOREPLY_TEMPLATE_ID) {
          await emailjs.send(
            process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID!,
            process.env.NEXT_PUBLIC_EMAILJS_AUTOREPLY_TEMPLATE_ID!,
            {
              user_name: formValues.senderName,
              user_email: formValues.senderEmail,
              reply_to: formValues.senderEmail,
              contact_reason: formValues.reasonToContact,
              user_message: formValues.senderMsg,
            },
            process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY!
          );
        }
