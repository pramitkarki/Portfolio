        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className={`${quentine.className} text-2xl font-semibold bg-gradient-to-r from-[hsl(var(--secondary))] to-[hsl(var(--secondary-foreground))] bg-clip-text text-transparent cursor-pointer hover:opacity-80 transition-opacity`}
