      ...
      <div className="px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            >
              <h3
                className="text-xl md:text-3xl font-bold mb-6 font-mono"
                style={{ color: "hsl(var(--foreground))" }}
              >
                My Socials
              </h3>
...
const ContactItem: React.FC<ContactItemProps> = ({
  ...
  const content = (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="relative p-4 rounded-xl transition-all duration-300 hover:bg-white/5 group cursor-pointer border border-transparent hover:border-primary/20 overflow-hidden"
    >
